            ...
            <form action="server/Order.php" method="post">
                <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phone" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Введите номер телефона">
                ...
                <div class="shopping-item">
                    <a href="cart.php">Корзина - <span class="cart-amunt"><?php echo $_SESSION['total'] ?> Руб.</span>
                        <i class="fa fa-shopping-cart"></i> <span
                                class="product-count"><?php echo(count($_SESSION['cart'])) ?></span></a></div>
            </div>
        </div>
    </div>
...
<div class="single-product-area">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="product-content-right w-100">
                            ...
                            <tr class="cart_item">
                                <td class="product-remove">
                                    <a title="Remove this item" class="remove"
                                       href="test.php?del_cart=<?php echo $item['id'] ?>">x</a>
                                </td>
